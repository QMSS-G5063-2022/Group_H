...
```{r}
#creating frequency table for two genres, Comedy vs. Thriller+Horror vs. Actions
...
colnames(top20) <- c("word","high", "low")
...
pyramid.plot(top20$low, top20$high,
                  labels = top20$word,
             top.labels = c("Low Revenue", " ", "High Revenue"),
